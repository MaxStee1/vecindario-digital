...
const CarritoPage = () => {
  ...
  const confirmarCompra = async () => {
    try {
      // Aquí deberás enviar los datos del carrito al endpoint de pedidos
      // await api.post("/comprador/pedidos", { productos: carrito });
      mostrarToast("success", "Compra confirmada (simulado)");
      setCarrito([]);
    } catch (error) {
